...
<div class="container-fluid">
    ...
    <div class="container-fluid mt-4">
        ...
        <table id="table" data-url="{{route('getAllCategory')}}" data-toggle="table" data-search="true" data-pagination="true">
            <thead>
                <tr>
                    <th data-formatter="iterator">Kategori Id</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('petugas.category') }}" method="post" id="addDataForm">
                        @csrf
                        <div class="mb-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('petugas.category') }}" method="post" id="editDataForm">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
...
@push('scripts')
    ...
    <script>
        ...
        $('#editDataForm').submit(function(event) {
            ...
            $.ajax({
                url: "{{ route('petugas.category') }}/" + $('#edit_kategori_id').val(),
                type: "POST",
                data: formData,
        ...
        function deleteData(button) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ url('categories/delete') }}/" + categoryId,
                        type: "DELETE",
                        data: {
                            "_token": "{{ csrf_token() }}"
                        },
